...
require.register("component-event-manager/index.js", function(module, exports, require){
...
require.register("component-events/index.js", function(module, exports, require){
...
require.register("select-switch/index.js", function(module, exports, require){
...
SelectSwitch.prototype.renderItems = function() {
  ...
  this.selectbox.find( 'option' ).each( function( i, el ){
    _this.addItem( '<li>' + el.innerText + '</li>' );
  } );
};
...
require.alias("component-jquery/index.js", "select-switch/deps/jquery/index.js");
